...
#include <stdio.h>
#include <conio.h>   
#include "c:\msvc\dani\include\v16colc.h"
...
extern unsigned init320200( void );
extern unsigned init640480( void );
extern unsigned init640350( void );
extern unsigned init640200( void );
...
{
 unsigned seg;
 if ( VMODE == 640480 )                       /* VGA mode selected? */
  {                                                           /* Yes */
